public class Track extends Product{
    ...
    public Track(String productCode, String productName, String manufacturerName,int retailPrice, int stock, 
                Gauge gauge, Scale scale, CurveRadius curveRadius, TrackType trackType){
