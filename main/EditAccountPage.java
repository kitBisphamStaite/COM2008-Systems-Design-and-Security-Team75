    ...
    private static void placeComponents(JFrame registerFrame, JPanel panel, Connection connection) {
        ...
        try {
            ...
            if (Login.getUserType().equals("CUSTOMER")) {
                ...
                editButton.setBounds(10, 440, 110, 25);
            ...
            homeButton.setBounds(10, 470, 110, 25);
